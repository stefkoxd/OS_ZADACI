...
public class TancSoStudentite {
    ...
    public static Semaphore dressingRoomM;
    public static Semaphore dressingRoomF;
    public static Semaphore availablePairs;


    public void init() {
        //TODO: da se implementira
        dressingRoomF = new Semaphore(10);
        dressingRoomM = new Semaphore(10);
        availablePairs = new Semaphore(3);
    }
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            dressingRoomM.acquire();
            show.presobleci();
            // samo maskoto go povikuva metodot tancuvaj
            availablePairs.acquire();
            show.tancuvaj();
            availablePairs.release();
            dressingRoomM.release();
        }
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            dressingRoomF.acquire();
            show.presobleci();
            dressingRoomF.release();
        }
